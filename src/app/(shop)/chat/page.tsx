                  ...
                  filteredConversations.map((conv) => (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <div className="w-12 h-12 rounded-full bg-gradient-to-br from-nepal-accent to-purple-500 flex items-center justify-center font-bold text-sm shrink-0">
            ...
            {selectedConversation ? (
              <div className="flex flex-1 flex-col w-full md:w-auto">
                ...
                <div className="p-4 border-b border-white/10 flex items-center justify-between bg-nepal-900/80 backdrop-blur">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full bg-gradient-to-br from-nepal-accent to-purple-500 flex items-center justify-center font-bold text-sm">
